...
namespace InfinityCode.OnlineMapsDemos
{
    public class Navigation : MonoBehaviour
    {
        ...
        public OnlineMapsGoogleRoutingResult.RouteLegStep[] steps { get; private set; }
        ...
        public void FindRoute()
        {
            ...
            OnlineMapsGoogleRouting request = OnlineMapsGoogleRouting.Find(
        ...
        private bool GetPointOnRoute(Vector2 position, out bool pointChanged)
        {
            ...
            OnlineMapsVector2d p1 = step.polyline.points[pointIndex];
            OnlineMapsVector2d p2 = step.polyline.points[pointIndex + 1];
            ...
            {
                step = steps[i];
                OnlineMapsVector2d[] polyline = step.polyline.points;
        ...
        private void OnRequestComplete(string response)
        {
            ...
            OnlineMapsGoogleRoutingResult.Route route = result.routes[0];
            if (route == null)
            {
                Debug.Log("Can't find route");
                return;
            ...
            routePoints = steps.SelectMany(s => s.polyline.points).ToArray();
            ...
            OnlineMapsGoogleRoutingResult.Viewport v = route.viewport;
        ...
        private void Start()
        {
            ...
            // If you use location service, subscribe to events
        ...
        private void Update()
        {
            ...
            if (!followRoute)
            {
                if (useLocationServicePosition) marker.position = GetUserLocation();
                return;
            }
        ...
        private void UpdateCoveredValues()
        {
            ...
            OnlineMapsGoogleRoutingResult.RouteLegStep s;
            ...
            OnlineMapsVector2d[] polyline = s.polyline.points;
            ...
            coveredDuration += (int)(stepDistance / s.distanceMeters * s.distanceMeters);
        }
