...
/// </summary>
public class OnlineMapsWWW: CustomYieldInstruction
{
    #region Actions
    ...
    /// <summary>
    /// This event occurs when URL is initialized, and allows you to modify it.
    /// </summary>
    ...
    private static MonoBehaviour temporaryBehaviour;
    ...
    private static MonoBehaviour coroutineBehaviour
    {
        get
        {
            if (OnlineMaps.instance) return OnlineMaps.instance;
            if (!temporaryBehaviour)
            {
                GameObject go = new GameObject("__OnlineMapsWWW__");
                go.hideFlags = HideFlags.HideInHierarchy;
                temporaryBehaviour = go.AddComponent<OnlineMapsWWWBehaviour>();
            }

            return temporaryBehaviour;
        }
    }
