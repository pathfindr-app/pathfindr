...
public class OnlineMapsProvider
{
    ...
    /// <summary>
    /// Number of maximum simultaneous downloads. 0 - unlimited.
    /// </summary>
    ...
    public static MapType CreateMapType(string id)
    {
        ...
        if (provider == null) provider = Create(parts[0]);
    ...
    private static void InitProviders()
    {
        providers = new []
        {
            ...
            new OnlineMapsProvider("google", "Google Maps")
            {
                ...
                _types = new[]
                {
                    ...
                    new MapType(TERRAIN)
                    {
                        ...
                        extraFields = new []
                        {
                            new ExtraField("Region", "region", "US"), 
                        }
                    }
                }
            },
            ...
            {
                url = "https://maps.hereapi.com/v3/{prop}/mc/{zoom}/{x}/{y}/png8?lang={lng}&style={variant}&{auth}",
                ...
                _types = new []
                {
                    new MapType(SATELLITE)
                    {
                        variantWithLabels = "lite.satellite.day",
                        variantWithoutLabels = "satellite.day",
                    },
                    new MapType("exploreDay")
                    {
                        variantWithLabels = "explore.day",
                    },
                    new MapType("lite.day")
                    {
                        variantWithLabels = "lite.day",
                    },
                    new MapType("logisticsDay")
                    {
                        variantWithLabels = "logistics.day",
                    },
                    new MapType("topoDay")
                    {
                        variantWithLabels = "topo.day",
                    },
                    new MapType("logisticsNight")
                    {
                        variantWithLabels = "logistics.night",
                    },
                    new MapType("exploreNight")
                    {
                        variantWithLabels = "explore.night",
                    },
                    new MapType("liteNight")
                    {
                        variantWithLabels = "lite.night",
                    },
                    new MapType("topoNight")
                    {
                        variantWithLabels = "topo.night",
                    },
                    new MapType("exploreSatelliteDay")
                    {
                        variantWithLabels = "explore.satellite.day",
                    },
                    new MapType("logisticsSatelliteDay")
                    {
                        variantWithLabels = "logistics.satellite.day",
                    },
                },

                extraFields = new IExtraField[]
                {
                    new ExtraField("Api Key", "apikey", ""),
                    new LabelField("- or -"),
                    new ExtraField("App ID", "appid", ""),
                    new ExtraField("App Code", "appcode", ""),
                }
            },
