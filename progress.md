...
- Release stage /tmp/pathfindr-lobby-perf-V6kjE6 cloned and SHA1-verified current production dpl_4nrDGPZqRHSX1FDCqvvwSGfuSJUR, preserved 256 unrelated files including Printshop/functions. Initial candidate preview authenticated storefront/builder/assets/policies/private-source checks passed; standard preview checker encounters Vercel login. Final promotion/checks recorded below when complete.
