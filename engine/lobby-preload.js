...
(() => {
    function create(deps){
        ...
        function ensure(mode){
            ...
            Promise.resolve().then(()=>restore?deps.restore?.(mode):null).then(saved=>{
            ...
            slot.task=(async()=>{
                ...
                try{
                    ...
                    let scene=null;
                    try{scene=await deps.details(city);}catch{ /* Keep the chosen city's roads; scenery can retry in the map. */ }
