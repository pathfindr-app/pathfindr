...
public class OnlineMapsUpdater : EditorWindow 
{
    ...
    public static void CheckNewVersionAvailable()
    {
        ...
        client.UploadDataAsync(new Uri("https://infinity-code.com/products_update/getlastversion.php"), "POST", Encoding.UTF8.GetBytes("c=" + (int)channel + "&package=" + OnlineMapsWWW.EscapeURL(packageID)));
    }
